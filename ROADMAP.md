...
4. **~~Valutazioni a cadenza mensile con notifica~~** — fatto: sezione "Da valutare" nella tab Valutazioni (chi è oltre la cadenza, chi non è mai stata valutata), cadenza configurabile per squadra (30 giorni di default), promemoria nel centro notifiche. Il promemoria è reattivo (compare all'apertura dell'app), non una notifica push a telefono spento.
